...
#whenever it is wrapper in quotes it is a string
year = "2024"
...
listOfMovies = ("The Crow", "Deadpool", "Beatlejuice")
...
#type conversion converting from data type to another
